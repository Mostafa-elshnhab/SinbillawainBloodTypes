...
class AddPageTwo extends StatelessWidget {
  AddPageTwo({Key? key,required this.name,required this.phone,required this.address}) : super(key: key);
  String name;
  String phone;
  String address;
...
//                       ),
                        ...
                        Text('هل يوجد ما يمنع التبرع حالياً؟',
                          style: TextStyle(
                            color: color6,
                            fontSize: 20.sp,
                            fontWeight: FontWeight.bold,
                        ...
                        (state is! CreateUserLoadingState)?    Center(
                          child: Container(
                            width: 150.w,
                            decoration: BoxDecoration(
                            ...
                            child: MaterialButton(
                              onPressed: ()
                              {
                               ...
                               String fakeUid=  List.generate(20, (index) => _chars[r.nextInt(_chars.length)]).join();
