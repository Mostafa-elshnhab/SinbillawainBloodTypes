...
class Fasela extends StatelessWidget {
  Fasela({Key? key, required this.faselaName}) : super(key: key);
  String faselaName;
  @override
          ...
          return RefreshIndicator(
            ...
            child: Scaffold(
              ...
              body: ListView.separated(
                  itemBuilder: (context, index) => !(cubit.users[index].man3 ==
                              'نعم' ||
                          !(cubit.users[index].fasela == '$faselaName'))
                      ? Padding(
